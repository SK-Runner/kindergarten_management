    ...
    <div class="teamanager">
        ...
        <div class="head">
            ...
            <div class="condition">
                ...
                <el-button class="conditionitem" @click="queryTeaByItems">搜索</el-button>
            </div>
            <div class="add-info">
                <el-button class="conditionitem" @click="insertDialogFormVisibleControl">添加教师</el-button>
            </div>
        </div>
        ...
        <div>
            ...
            :data="dataList"
            style="width: 100%">
                <el-table-column prop="userid" label="教师ID"></el-table-column>
